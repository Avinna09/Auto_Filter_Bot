...
API_ID = int(environ.get('API_ID', '28793070')) # API ID from my.telegram.org
API_HASH = environ.get('API_HASH', '067b44ae58ea9e7e9be48b6b7b54408b')  # API Hash from my.telegram.org
BOT_TOKEN = environ.get('BOT_TOKEN', "7755766944:AAFl3SrbZgwfnE9x-YObx-FsArYxifv74Ag")    # Bot token from @BotFather
...
PICS = (environ.get('PICS', 'https://graph.org/file/cb73c032ec57bb544f07c-e499b1a160906623be.jpg https://graph.org/file/d036f0ca47e9ce512164f-050dd1bc4c8972f954.jpg')).split()  # Sample pic
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6057111659').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002496972546').split()]  # Channel id for auto indexing (make sure bot is admin)

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002397194535'))  # Log channel id (make sure bot is admin)
...
# FORCE_SUB 
auth_req_channel = environ.get('AUTH_REQ_CHANNEL', '-1002493123293')  # requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://avirammahalik818:LbtVnIfYDoFJMV03@cluster0.hs3b6.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")  # MongoDB URI for the database
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002798622911'))  # Notification of sent to your channel
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002281894894')) #Verification Channel Id 
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002336361980')) #If Anyone Set Your Bot In Any Group And Set Shortner In That Group Then In This Channel The All Details Come
VERIFY_IMG = environ.get("VERIFY_IMG", "https://telegra.ph/file/9ecc5d6e4df5b83424896.jpg")

TUTORIAL = environ.get("TUTORIAL", "https://t.me/movie_star65/8")   # Tutorial link for verification
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/movie_star65/8")   # Second tutorial link for verification
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/movie_star65/8")   # Third tutorial link for verification

# Verification (Must Fill All Veriables. Else You Got Error
SHORTENER_API = environ.get("SHORTENER_API", "b8785d31f2262c0c7673d012d5cbadb8d5d9e35c") # Shortener API key
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "short2url.in") # Shortener website

SHORTENER_API2 = environ.get("SHORTENER_API2", "b8785d31f2262c0c7673d012d5cbadb8d5d9e35c")  # Shortener API key for second website
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", "short2url.in") # Shortener website for second website

SHORTENER_API3 = environ.get("SHORTENER_API3", "b8785d31f2262c0c7673d012d5cbadb8d5d9e35c")  
SHORTENER_WEBSITE3 = environ.get("SHORTENER_WEBSITE3", "short2url.in") # Shortener website for third website

TWO_VERIFY_GAP = int(environ.get('TWO_VERIFY_GAP', "3000")) # Time gap for two-step verification in seconds (default: 20 minutes)
THREE_VERIFY_GAP = int(environ.get('THREE_VERIFY_GAP', "54000"))    

# ============================
# Channel & Group Links Configuration
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/movie_request04') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/movie_bot_owner') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/Am_Updated_Movie') # Update channel link for the bot
